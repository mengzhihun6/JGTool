...
#import "JGSocketRocketUtility.h"
...
@interface JGSocketRocketUtility()<SRWebSocketDelegate>
{
    int _index;
    NSTimer * heartBeat;
...
@implementation JGSocketRocketUtility

+ (JGSocketRocketUtility *)instance {
    static JGSocketRocketUtility *Instance = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        Instance = [[JGSocketRocketUtility alloc] init];
    });
    return Instance;
}
